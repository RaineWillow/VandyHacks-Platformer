...
type Map
    ...
    public:
        ...
        declare function getTile(byval tx as integer, byval ty as integer) as Tile
...
function Map.getTile(byval tx as integer, byval ty as integer) as Tile
    return this.chunk(tx, ty)
end function
