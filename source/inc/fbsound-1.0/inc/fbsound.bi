...
#ifdef __FB_WIN32__
 #ifndef __FB_64BIT__
  #libpath "source/inc/fbsound-1.0/lib/win32/"
 #else
  #libpath "source/inc/fbsound-1.0/lib/win64/"
 #endif 
#else
 #ifdef  __FB_LINUX__
  #ifndef __FB_64BIT__
   #libpath "source/inc/fbsound-1.0/lib/lin32/"
  #else
   #libpath "source/inc/fbsound-1.0/lib/lin64/"
  #endif 
 #else
